...
class DareFrontCartWidget extends StatelessWidget {
  const DareFrontCartWidget({super.key});
...
class DareRareCartWidget extends StatelessWidget {
  final String questionText;
  final Function onBackClick;
  const DareRareCartWidget({super.key, required this.questionText, required this.onBackClick});
