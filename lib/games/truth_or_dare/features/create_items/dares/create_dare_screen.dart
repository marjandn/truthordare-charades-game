...
import 'create_dare_controller.dart';

class CreateDareScreen extends StatelessWidget {
  CreateDareScreen({super.key});

  final CreateDareController _controller = Get.find<CreateDareController>();

  final TextEditingController _contentController = TextEditingController();

  @override
  Widget build(BuildContext context) {
    _controller.daresList.clear();
    WidgetsBinding.instance.addPostFrameCallback((_) => _controller.getSavedDares());

    return GameScaffold(
      appBar: context.simpleAppbar(title: "جرات ها"),
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                RoundButtonWidget(
                    onButtonTapped: () {
                      _controller.addDareToList(_contentController.text);
          ...
          Expanded(
            child: AnimatedList(
              ...
              initialItemCount: _controller.daresList.length,
              ...
              itemBuilder: (context, index, animation) {
                return SlideTransition(
                    ...
                    child: Obx(
                      () => TextItemWidget(
                          text: _controller.daresList[index].content,
                          onDeleteItemClick: () {
                            _controller.removeSpecificDare(index, _controller.daresList[index].content);
                          }),
                    ));
              },
            ),
